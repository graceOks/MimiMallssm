...
<script type="text/javascript">
    ...
    /*function fileChange() {//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
        ...
        $.ajaxFileUpload({
            ...
            success: function (obj) {//服务器成功响应处理函数
                ...
                imgObj.attr("src", "/MimiMallssm/image_big/" + obj.imgurl);
    ...
    <%--var pri = ${pageContext.request.contextPath}--%>
    function upload(){
        var formData = new FormData();
        formData.append('pimage', $('#pimage')[0].files[0]);
        $.ajax({
            type: "post",
            url:  "http://localhost:8080/MimiMallssm/prod/ajaxImg.action",
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><br>
                        ...
                        <div id="imgDiv" style="display:inline-block;background-color: yellow; width: 80px; height: 80px;border: 2px red solid";></div>
                        <br><br><br><br>
                        <%--<input type="file" id="pimage" name="pimage" onchange="fileChange()">--%>
                        <br>
                        <input type="file" id="pimage" name="pimage" style="width: 150px;">
                        <input onclick="upload()" type="button" value="test" />
